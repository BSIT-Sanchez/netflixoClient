      ...
      <div className='container mx-auto py-6 px-2 lg:grid gap-10 grid-cols-7 justify-between items-center'>
        ...
        <div className="col-span-3">
            <form className="w-full text-sm bg-dryGray rounded flex-btn gap-4 ">
              <button type="submit" className="bg-subMain w-12 flex-colo h-11 rounded text-white">
                <FaSearch/>
              </button>
              <input type="text" placeholder='Search Movie Name From Here...' className='font-medium placeholder:text-border text-sm w-11/12 h-11 bg-transparent border-none px-2 text-black'/>
            </form>
        </div>      
        {/* menus */}
