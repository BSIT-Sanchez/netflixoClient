...
function Login() {
  return (
    <Layout>
      <div class="container mx-auto px-2 my-24 flex-colo">
        <div class="w-full 2xl:w-2/5 gap-8 flex-colo p-8 sm:p-14 md:w-3/5 bg-dry  rounded-lg border border-border">
          <img src="/images/logo.png" alt="logo" class="w-full h-12 object-contain"/>
