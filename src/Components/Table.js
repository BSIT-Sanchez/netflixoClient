        ...
        <tr key={i}>
            <td className={`${Text}`}>
                <div className='w-12 p-1 bg-dry border border-border h-12 rounded overflow-hidden'>
                    <img src={`/images/movies/${movie.titleImage}`} className="h-full w-full object-cover" alt={movie?.name}/>
                </div>
            </td>
            ...
            <td className={`${Text} float-right flex-rows gap-2`}>
                {
                    ...
                    <>
                        ...
                        <Link to={`/movies/${movie?.name}`} className="bg-subMain text-white rounded flex-colo w-7 h-7">
                            <GoEye/>
                        </Link>
                    </>
                    )
